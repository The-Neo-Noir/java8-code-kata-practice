...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(mapper->mapper.getAge()).sorted((a,b)->{return a.compareTo(b);});
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a,b)->{return b.compareTo(a);};

		Stream<Integer> sortedAgeStream = customerList.stream().map(mapper->mapper.getAge()).sorted(descOrder);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a,b)->{return b.getBudget().compareTo(a.getBudget());}).map(mapper->mapper.getName()).limit(3);
    ...
    public void distinctAge() {
         ...
         */
        Stream<Integer> distinctAgeStream = customerList.stream().map(mapper->mapper.getAge()).distinct();
    ...
    public void itemsCustomersWantToBuy() {
        ...
        Stream<String> itemStream = customerList.stream().map(mapper->mapper.getWantToBuy()).flatMap(ma->ma.stream().map(mapper->mapper.getName()));

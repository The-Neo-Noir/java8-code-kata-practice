...
public class Exercise4Test extends ClassicOnlineStore {
    ...
    public void isThereAnyoneOlderThan40() {
         ...
         */
        boolean olderThan40Exists = customerList.parallelStream().anyMatch(predicate->predicate.getAge()>40);
    ...
    public void isEverybodyOlderThan20() {
         ...
         */
        boolean allOlderThan20 = customerList.stream().allMatch(predicate->predicate.getAge()>20);
    ...
    public void everyoneWantsSomething() {
         ...
         */
        boolean everyoneWantsSomething = customerList.stream().noneMatch(predicate->predicate.getWantToBuy().isEmpty());
